...
// Ported from MainOffenseCombatValue$MainOffenseCombatValueBuilder#build().
main_offense_combat_value_main_offense_combat_value_builder_build :: proc(
	self: ^Main_Offense_Combat_Value_Main_Offense_Combat_Value_Builder,
) -> ^Main_Offense_Combat_Value {
	friend_units := self.friend_units
	if friend_units == nil {
		friend_units = main_offense_combat_value_default_friend_units()
	}
	enemy_units := self.enemy_units
	if enemy_units == nil {
		enemy_units = main_offense_combat_value_default_enemy_units()
	}
	return main_offense_combat_value_new(
		self.game_sequence,
