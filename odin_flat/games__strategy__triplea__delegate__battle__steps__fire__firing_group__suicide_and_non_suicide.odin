...
// Static factory — Java: SuicideAndNonSuicide.of(Multimap<UnitType, Unit>, Collection<Unit>).
// Generated by Lombok's @Value(staticConstructor = "of"); delegates to the all-args
// constructor proc above.
firing_group_suicide_and_non_suicide_of :: proc(
	suicide_groups: ^Multimap(^Unit_Type, ^Unit),
	non_suicide_group: [dynamic]^Unit,
) -> ^Firing_Group_Suicide_And_Non_Suicide {
	return firing_group_suicide_and_non_suicide_new(suicide_groups, non_suicide_group)
}
