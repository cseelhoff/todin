...
Player_Types_3 :: struct {
	using player_types_type: Player_Types_Type,
}

// Java anonymous subclass `PlayerTypes$3` (PRO_AI). Its synthetic
...
player_types_3_new :: proc(label: string) -> ^Player_Types_3 {
	self := new(Player_Types_3)
