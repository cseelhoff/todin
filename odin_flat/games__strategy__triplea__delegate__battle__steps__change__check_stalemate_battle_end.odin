...
check_stalemate_battle_end_new :: proc(
	...
	self.get_order = check_stalemate_battle_end_v_get_order
	self.execute = check_stalemate_battle_end_v_execute
	return self
}

check_stalemate_battle_end_v_get_order :: proc(self: ^Battle_Step) -> Battle_Step_Order {
	return check_stalemate_battle_end_get_order(cast(^Check_Stalemate_Battle_End)self)
}
