...
aa_fire_and_casualty_step_get_steps :: proc(self: ^Aa_Fire_And_Casualty_Step) -> [dynamic]^Battle_Step {
	...
	fire_round_steps_factory_builder_firing_group_splitter(builder, firing_group_splitter_aa_apply_raw, splitter)
	...
	fire_round_steps_factory_builder_dice_roller(builder, aa_fire_and_casualty_step_aa_dice_roller_apply_stateless)
	fire_round_steps_factory_builder_casualty_selector(builder, aa_fire_and_casualty_step_select_aa_casualties_apply_stateless)
